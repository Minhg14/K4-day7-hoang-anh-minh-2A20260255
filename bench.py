...
def run_benchmark() -> str:
    ...
    p(f"Sinh viên: Hoàng Anh Minh (2A20260255) | Nhóm K4-L3B")
    ...
    benchmark_queries = [
        ...
        {
            "id": 3,
            "query": "Thời gian xử lý bảo hành tiêu chuẩn đối với sản phẩm chính hãng tại Tiki là bao nhiêu ngày?",
            "filter": None,
            "gold_doc": "tiki-buyer-warranty-policy",
            "gold_answer": "Từ 07 đến 14 ngày làm việc kể từ ngày trung tâm nhận được sản phẩm.",
            "target_keyword": "07 đến 14 ngày làm việc",
        },
        {
            "id": 4,
            "query": "Người bán Lazada phải sử dụng thùng carton mấy lớp đối với hàng hóa nặng trên 5 kg hoặc hàng dễ vỡ?",
            "filter": {"audience": "seller"},
            "gold_doc": "lazada-seller-packaging-guidelines",
            "gold_answer": "Thùng carton tối thiểu 5 lớp (và quấn 2-3 lớp xốp khí dày tối thiểu 3 cm).",
            "target_keyword": "5 lớp",
        },
        {
            "id": 5,
            "query": "Mức bồi thường tổn thất tối đa đối với đơn hàng vận chuyển không mua bảo hiểm hàng hóa là bao nhiêu?",
            "filter": None,
            "gold_doc": "ecommerce-shipping-damage-compensation",
